        ...
        <div className="contact-grid">
          ...
          <div className="terminal animate-on-scroll" style={{ transitionDelay: '0.15s' }}>
            ...
            <div className="terminal-body contact__terminal-body">
              ...
              <div className="t-out"><span className="t-val">SOC Analyst · Pentest · OSINT</span></div>
              <div className="t-out"><span className="t-val">Red Team · Threat Intelligence</span></div>
